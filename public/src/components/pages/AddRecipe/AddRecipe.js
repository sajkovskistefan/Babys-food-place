   ...
   const updateRecipe = async (updateRecipeData) => {
    ...
    return(
        <div className='my-recipe'>
            ...
            <h2 className="title-recipes">Add Recipe</h2>
            ...
            <div className='container-recipe'>    
             <div className='recipe-image'>   
                <label className='label'>Recipe Image</label>
                     <img src={updateRecipeData.img ? `http://localhost:10002/api/v1/storage/${updateRecipeData.img}` : image || image_burger} className='image-recipe'></img> 
